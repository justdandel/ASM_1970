    ...
    public partial class ok : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, "ahsufhadhsafasdhaa", 2, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiUAaDFqobRwQ7KdQLQF3qkBYmb7rETd2TlA&usqp=CAU", "asdj", 30.399999999999999 });

            migrationBuilder.InsertData(
                table: "books",
                columns: new[] { "Id", "AuthorID", "CategoryID", "Description", "Edition", "Img", "Name", "Price" },
                values: new object[] { 2, 1, 1, "kjhadbfhlgsdafb saldlasdasd", 3, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiUAaDFqobRwQ7KdQLQF3qkBYmb7rETd2TlA&usqp=CAU", "oiwouas", 99.0 });

            migrationBuilder.InsertData(
                table: "books",
                columns: new[] { "Id", "AuthorID", "CategoryID", "Description", "Edition", "Img", "Name", "Price" },
                values: new object[] { 3, 4, 3, "kalhdfladhlahldf fadhfahdfaf", 2, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiUAaDFqobRwQ7KdQLQF3qkBYmb7rETd2TlA&usqp=CAU", "uhsdbhasad", 38.0 });
